...
import DeskNodeConfigurator from '../components/DeskNodeConfigurator'
...
export default function SovereignTiers({ onRequestQuote }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 lg:py-12 space-y-12">
      ...
      {/* Tier Selector — shared across all tiers */}
      <div className="grid grid-cols-3 gap-3">
        {TIERS.map((t) => (
          ...
          >
            ...
            <div className="text-[10px] text-cyan mt-1">
              {t.id === 'tier1' ? 'Labor + hardware, itemized below' : `Base: $${t.base.toLocaleString()}`}
            </div>
          </button>
        ))}
      </div>

      {/* Desk Node: new hours-based configurator */}
      {selectedTier === 'tier1' && <DeskNodeConfigurator onRequestQuote={onRequestQuote} />}

      {/* SOHO Vault & Home Core: existing BOM/upgrade toggle system */}
      {selectedTier !== 'tier1' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-surface border border-hairline rounded-xl p-6 space-y-6">
            ...
            {/* Thermal, Power & Compute Upgrades */}
            <div className="space-y-3">
              <label className="text-xs font-bold text-muted uppercase">Thermal, Power & Compute Upgrades</label>
            ...
            {/* Local Encrypted Storage Capacity */}
            <div className="space-y-2 border-t border-hairline pt-4">
              <label className="text-xs font-bold text-muted uppercase">Local Encrypted Storage Capacity</label>
            ...
            <div className="space-y-3 border-t border-hairline pt-4">
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold text-muted uppercase flex items-center gap-1.5">
                  ...
                  <span>Optional Zero-Trust Maintenance Plan</span>
                </label>
