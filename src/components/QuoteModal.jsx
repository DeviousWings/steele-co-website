  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex justify-center items-center p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-cyan-400 rounded-xl max-w-lg w-full p-6 space-y-6 shadow-[0_0_35px_rgba(0,229,255,0.25)] text-slate-200 my-8 relative pointer-events-auto">
        ...
        {/* 100% Native HTML Form POST to Formspree */}
        <form action="https://formspree.io/f/xgawyenw" method="POST" className="space-y-4 text-xs">
          ...
          {selectedConfig && (
            <div className="p-3 bg-slate-950 border border-cyan-500/40 rounded-lg space-y-2 font-mono text-[11px]">
              ...
              {/* Hidden Inputs passed directly to Formspree */}
          ...
          {/* Native Submit Button - Guaranteed to fire */}
          <button 
            type="submit"
            className="w-full py-3 bg-cyan-400 hover:bg-cyan-500 text-slate-950 font-black uppercase text-xs rounded transition-all shadow-[0_0_15px_rgba(0,229,255,0.2)] cursor-pointer pointer-events-auto"
          >
